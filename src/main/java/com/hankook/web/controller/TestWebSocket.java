...
public class TestWebSocket {
	...
	public static final java.util.Set<Session> sessions = java.util.Collections.synchronizedSet(new java.util.HashSet<Session>());
    ...
    public String testView(){
    	...
    	System.out.println("in webSocket.do");
    	logger.info("in /test.do");
